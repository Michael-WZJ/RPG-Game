...
public class LoadFileTests {
    ...
    @Test
    void testGameState() {
        GameModel modelBas = serverBas.getGameModel();
        ...
        GameModel modelExt = serverExt.getGameModel();
        entities = modelExt.getIdentifiers().get(ENTITY);
        actions = modelExt.getIdentifiers().get(ACTION);
